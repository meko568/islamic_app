          ...
          children: [
            ...
            _buildSectionCard(
              ...
              children: [
                ...
                ListTile(
                  title: Text(
                    AppStrings.get('quran_translation', lang),
                    style: GoogleFonts.cairo(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                    ),
                  ...
                  subtitle: Text(
                    settings.quranTranslationLang == 'en'
                  ...
                  onTap:
                      () => _showTranslationSelectionDialog(
                        context,
                        lang,
                        settings,
                      ),
    ...
    return _buildSectionCard(
      ...
      children: [
        ...
        if (settings.enabled) ...[
          ...
          SwitchListTile(
            title: Text(
              AppStrings.get('auto_show_overlay', lang),
              style: GoogleFonts.cairo(
                fontSize: 16,
                fontWeight: FontWeight.w600,
              ),
            ...
            subtitle: Text(
              AppStrings.get('auto_show_overlay_desc', lang),
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        // Open app settings as well for "App Launch"
                        await openAppSettings();
                      },
                      icon: const Icon(Icons.settings, size: 18),
                      label: Text(
                        AppStrings.get('fix_background_issues', lang),
                        style: GoogleFonts.cairo(fontSize: 12),
                      ),
